...
| PPT 출력 | 구현 완료 | 표지·목차·섹션 슬라이드, 긴 섹션 자동 분할 |

## E2E 통합 검증 결과 (2026-05-14 / 2026-05-15 PPT 추가)
...
| PPT 내보내기 | `POST /exports/ppt` | ✅ 31,306 bytes `.pptx` 반환 | 표지·목차·섹션 슬라이드 자동 생성 |
